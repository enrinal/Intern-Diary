...
func (_m *Repository) AddItem(item string, qty int64) error {
...
func (_m *Repository) GetCustCart(custid int64) ([]*models.Cart, error) {
...
func (_m *Repository) RemoveItem(item string) error {
	ret := _m.Called(item)
